...
public class _7 {
    ...
    private static void exercise1() {
        ...
        System.out.println("text in upper case '"+Name.toUpperCase()+"' text in lower case '"+Name.toLowerCase()+"'");
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "raffaele";
        String middleName = "pippo";
        String lastName = "fusco";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = ""+ 67 +" "+ true+" "+1.5+" "+'c' ; // <--- Edit this line
